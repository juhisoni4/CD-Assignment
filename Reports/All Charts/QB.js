	...
	function drawRegionsMap() {		     
		...
		for (var i = 0; i < jsonData10.length; i++){
			data.push(jsonData10[i]);
		}
      
		var data1 = new google.visualization.arrayToDataTable(data);
		var options = {'title':'QB wise report',
                       'width':1000,
                       'height':500,        
          colorAxis: {colors: ['#FFA733', '#10AB52', '#F54F0F']},          
        };
        // Instantiate and draw our chart, passing in some options.
        var chart = new google.visualization.GeoChart(document.getElementById('QB_div'));
